# Bookmark Freshness Review (`bookmark-freshness-review`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://bookmark-freshness-review.sociobot.in`. Artifact class: `browser-extension`.

...
| Bookmark review preview | 3 | Pass |
...
| Where bookmark data goes | 4 | Pass |
...
## Changed demo and license states

| Copy unit | Words | Result |
| --- | ---: | --- |
| Decide which bookmarks to keep | 5 | Pass |
| Link-check limit | 2 | Pass |
| Your verified license allows unlimited link checks. | 7 | Pass |
| This license is not active. The 50-check limit still applies. | 10 | Pass |
| The license could not be checked. The 50-check limit still applies. Try again when you are online. | 17 | Pass |

## Terminology

| Concept | Term used |
| --- | --- |
| Imported collection | bookmark archive; archive after first mention |
| Network action | link check |
| Unsuccessful request | failed check |
| Redirect or canonical change | moved or changed |
| Review choices | keep, review later, archive |
| Paid restriction | 50-check limit |

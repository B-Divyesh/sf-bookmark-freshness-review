...
Landing-page sentences and labels were checked against the plain-words rules. No sentence exceeds 22 words. No banned marketing words appear.
...
| Choose whether to keep, repair, or archive each bookmark. | 10 | Pass |
| Bookmark review preview | 3 | Pass |
| See bookmarks that need a decision | 7 | Pass |
| See saved year, link result, duplicate status, and a note for each bookmark. | 13 | Pass |
| How bookmark review works | 4 | Pass |
| Review bookmarks in three steps | 6 | Pass |
| Choose a standard browser bookmark HTML file. | 8 | Pass |
| Start a link check. | 5 | Pass |
...
| Your bookmarks stay in browser storage | 7 | Pass |
